...
chat_model = ChatGoogleGenerativeAI(api_key="AIzaSyCK1QRQbjrAotbiTmmSjdkNYtK14df0JLs", model="gemini-2.0-flash-exp")
...
st.title("🤖 AI Converstational Data Science Tutor🎓🚀")
